...
　尚、この次世代型避難訓練のライセンスは CC BY-SA 4.0とし、© 一般社団法人防災ガール, CC BY-SA 4.0という表記を用いることとする。
...
### 1.TOLAF
　TOLAFとは、Think Our Life and Futureの略で、LUDUSOS独自の用語である。予測されている南海トラフをはじめとする様々な災害に関し、自分たちの生活や未来、大切な人のことを考えて行動するという意味が込められている。この避難訓練は、事前情報なく、携帯電話も使用せず、チームで協力し、同行スタッフの問いかけのもと、制限時間内にたどり着ける最も安全な場所を見つけ出す街歩き型訓練である。訓練の流れは以下の通りである。
#### 流れ
１．集合
２．ルール説明
３．チーム別街歩き
